                    ...
                    child: Column(
                      children: [
                            ...
                            (index) => Card(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  ...
                                  color: fromHex(
                                    getColor(widget.pokemon.types[index].name),
                                  ),
                                ),
                                height: 24,
                                width: 55.2,
                        ...
                        Padding(
                          ...
                          child: Text(
                            "Sobre",
                            style: myTextStyleBase.cardTitle(fromHex(
                                getColor(widget.pokemon.types[0].name))),
                          ),
                        ),
                        Row(
                        ...
                        Row(
                          ...
                          children: [
                            Column(
                              children: [
                                Text('HP',
                                    style: myTextStyleBase.stats(fromHex(
                                        getColor(
